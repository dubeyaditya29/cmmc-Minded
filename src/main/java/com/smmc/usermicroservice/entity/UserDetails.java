package com.smmc.usermicroservice.entity;
...
public class UserDetails {
    ...
    // args constructor
    public UserDetails(ObjectId  _id, Role role, String email, Status status, String name, Long phone, List<String> services, List<String> languages, List<String> locations, String companyName, String instralink, String websitelink, String about, String profile_pic_url, String public_name, Address address) {
        this._id = _id;
        this.role = role;
        this.email = email;
        this.status = status;
